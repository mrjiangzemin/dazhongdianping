package org.whj.dao.interceptor;
...
import org.whj.bean.BaseBean;
import org.whj.bean.Page;

import java.sql.Connection;
import java.sql.PreparedStatement;
import java.sql.ResultSet;
import java.util.Properties;
//Type描述的要拦截的接口，methond指向你要拦截的方法 ARGS参数
